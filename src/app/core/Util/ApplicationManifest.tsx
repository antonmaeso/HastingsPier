...
export const appMap = new Map<string, App>([
    ["ApplicationSelection", new App(<AppSelection />, "Default for selecting an app", "Hastings Pier")],
    ["Octane", new App(<OctaneParent />, "Burn down your Octane Tasks to keep accurate track of time taken", "Octane Burner")],
    ["BatManager", new App(<Example />, "For testing stuff as we develop","Dev Experiments")],
    ["RmDashboard", new App(<RmDash />, "Show RM Dashboard in app","RM Dashboard")],
